...
public class PushServiceSocket {
  ...
  public void sendRead(String destination, long messageId, Optional<String> relay) throws IOException {
    String path = String.format(READ_PATH, destination, messageId);
