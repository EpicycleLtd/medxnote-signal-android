...
import com.medxnote.securesms.util.MmsCharacterCalculator;
import com.medxnote.securesms.util.PushCharacterCalculator;
import com.medxnote.securesms.util.SmsCharacterCalculator;
import com.medxnote.securesms.util.dualsim.SubscriptionInfoCompat;
import com.medxnote.securesms.util.CharacterCalculator;
...
public class TransportOptions {
  ...
  public TransportOptions(Context context, boolean media) {
    ...
    setDefaultTransport(TransportOption.Type.TEXTSECURE);
  }
  ...
  private List<TransportOption> initializeAvailableTransports(boolean isMediaMessage) {
    ...
    results.add(new TransportOption(TransportOption.Type.TEXTSECURE, R.drawable.ic_send_push_white_24dp,
                                                                        ...
                                                                        @NonNull CharacterCalculator characterCalculator)
  {
    ...
    if (subscriptions.size() < 2) {
      results.add(new TransportOption(TransportOption.Type.SMS, R.drawable.ic_send_sms_white_24dp,
