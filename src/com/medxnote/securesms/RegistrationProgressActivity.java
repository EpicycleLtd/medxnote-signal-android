...
public class RegistrationProgressActivity extends BaseActionBarActivity {
  ...
  private void handleGcmTimeout(RegistrationService.RegistrationState state) {
  ...
  private void handleMultiRegistrationError(RegistrationService.RegistrationState state) {
    handleVerificationTimeout(state);
