...
import com.medxnote.securesms.mms.CompatMmsConnection;
import com.medxnote.securesms.mms.MediaConstraints;
import com.medxnote.securesms.mms.MmsSendResult;
...
import com.medxnote.securesms.util.Hex;
import com.medxnote.securesms.util.NumberUtil;
import com.medxnote.securesms.util.SmilUtil;
import com.medxnote.securesms.util.TelephonyUtil;
...
public class MmsSendJob extends SendJob {
      ...
      throws UndeliverableMessageException
  {
    ...
    for (String number : numbers) {
      if (message.getDistributionType() == ThreadDatabase.DistributionTypes.CONVERSATION) {
