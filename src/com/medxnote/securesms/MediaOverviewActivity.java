...
import com.medxnote.securesms.database.ImageDatabase;
...
import com.medxnote.securesms.util.SaveAttachmentTask;
        ...
        new ProgressDialogAsyncTask<Void, Void, List<SaveAttachmentTask.Attachment>>(c,
          ...
          protected List<SaveAttachmentTask.Attachment> doInBackground(Void... params) {
            ...
            while (cursor != null && cursor.moveToNext()) {
              ImageDatabase.ImageRecord record = ImageDatabase.ImageRecord.from(cursor);
