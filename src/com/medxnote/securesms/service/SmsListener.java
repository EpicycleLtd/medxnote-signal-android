...
import com.medxnote.securesms.jobs.SmsReceiveJob;
...
public class SmsListener extends BroadcastReceiver {
  ...
  private static final Pattern CHALLENGE_PATTERN = Pattern.compile(".*Your Medxnote verification code:? ([0-9]{3,4})-([0-9]{3,4}).*", Pattern.DOTALL);
