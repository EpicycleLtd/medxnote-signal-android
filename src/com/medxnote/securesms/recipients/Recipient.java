...
import com.medxnote.securesms.recipients.RecipientProvider.RecipientDetails;
...
public class Recipient {
  ...
  Recipient(long recipientId, RecipientProvider.RecipientDetails details) {
    this.recipientId  = recipientId;
...
//    return (name == null ? "firstname.surname@hospitalname.tld" : name);
  ...
  public static Recipient getUnknownRecipient() {
    return new Recipient(-1, new RecipientProvider.RecipientDetails("Unknown", "Unknown", null,
