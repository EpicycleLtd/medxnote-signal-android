 ...
 */
package com.medxnote.securesms.recipients;
...
import com.medxnote.securesms.contacts.avatars.ContactPhoto;
...
import com.medxnote.securesms.util.NumberUtil;
import com.medxnote.securesms.util.Util;
import com.medxnote.securesms.color.MaterialColor;
import com.medxnote.securesms.recipients.Recipient.RecipientModifiedListener;
import com.medxnote.securesms.util.FutureTaskListener;
import com.medxnote.securesms.util.ListenableFutureTask;
...
public class Recipients implements Iterable<Recipient>, RecipientModifiedListener {
  ...
  Recipients(@NonNull  List<Recipient> recipients,
             ...
             @NonNull  ListenableFutureTask<RecipientPreferenceDatabase.RecipientsPreferences> preferences)
  {
    this.recipients = recipients;
    ...
    preferences.addListener(new FutureTaskListener<RecipientPreferenceDatabase.RecipientsPreferences>() {
      @Override
