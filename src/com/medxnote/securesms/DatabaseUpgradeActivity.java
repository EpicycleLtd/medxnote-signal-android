...
import com.medxnote.securesms.crypto.storage.TextSecurePreKeyStore;
import com.medxnote.securesms.database.PushDatabase;
import com.medxnote.securesms.database.model.MessageRecord;
import com.medxnote.securesms.jobs.DirectoryRefreshJob;
      ...
      implements DatabaseUpgradeListener
  {
    ...
    private void schedulePendingIncomingParts(Context context) {
      ...
      for (DatabaseAttachment attachment : pendingAttachments) {
        final MmsDatabase.Reader reader = mmsDb.readerFor(masterSecret, mmsDb.getMessage(attachment.getMmsId()));
