...
public interface MmsSmsColumns {
  ...
  public static final String NORMALIZED_DATE_RECEIPT_RECEIVED = "date_receipt_received";
  ...
  public static class Types {
    ...
    protected static final long KEY_UPDATED_BIT                  = 0x01000000;
    ...
    public static boolean isUpdatedType(long type) {
      return (type & KEY_UPDATED_BIT) != 0;
    }
