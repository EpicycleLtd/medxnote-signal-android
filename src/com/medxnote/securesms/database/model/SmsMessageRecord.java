...
public class SmsMessageRecord extends MessageRecord {
  ...
  public SmsMessageRecord(Context context, long id,
                          ...
                          int subscriptionId, boolean isEdit) {
    super(context, id, body, recipients, individualRecipient, recipientDeviceId,
            dateSent, dateReceived, dateRead, threadId, status, receiptCount, type,
            mismatches, new LinkedList<NetworkFailure>(), subscriptionId, isEdit);
  }
  ...
  public SpannableString getDisplayBody() {
    ...
    } else if (isKeysUpdated()){
      return emphasisAdded(context.getString(R.string.MessageDisplayHelper_keys_have_changed, getIndividualRecipient().toShortString()));
