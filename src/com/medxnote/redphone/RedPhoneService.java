...
import com.medxnote.redphone.audio.IncomingRinger;
import com.medxnote.redphone.audio.OutgoingRinger;
import com.medxnote.redphone.call.CallManager;
import com.medxnote.redphone.call.CallStateListener;
import com.medxnote.redphone.call.InitiatingCallManager;
import com.medxnote.redphone.call.LockManager;
import com.medxnote.redphone.call.ResponderCallManager;
import com.medxnote.redphone.crypto.zrtp.SASInfo;
import com.medxnote.redphone.pstn.CallStateView;
import com.medxnote.redphone.pstn.IncomingPstnCallListener;
...
import com.medxnote.redphone.ui.NotificationBarManager;
import com.medxnote.redphone.util.UncaughtExceptionHandlerManager;
import com.medxnote.securesms.database.DatabaseFactory;
import com.medxnote.securesms.events.RedPhoneEvent;
...
import com.medxnote.redphone.util.AudioUtils;
...
public class RedPhoneService extends Service implements CallStateListener, CallStateView {
  ...
  public void notifyCallConnected(SASInfo sas) {
    ...
    Recipient recipient = getRecipient();
    sendMessage(RedPhoneEvent.Type.CALL_CONNECTED, recipient, sas.getSasText());
  ...
  public void notifyServerMessage(String message) {
    sendMessage(RedPhoneEvent.Type.SERVER_MESSAGE, getRecipient(), message);
    this.terminate();
  }

  public void notifyClientError(String msg) {
    sendMessage(RedPhoneEvent.Type.CLIENT_FAILURE, getRecipient(), msg);
    this.terminate();
  }
  ...
  private void sendMessage(@NonNull RedPhoneEvent.Type type,
